        ...
        <div className="relative z-10 max-w-4xl space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-3">
            ...
            <div className="bg-white/5 backdrop-blur border border-white/10 rounded-xl p-3">
              ...
              <div className="text-xs text-slate-400 font-medium">Mục tiêu đạt chuẩn 2026</div>
            </div>
            <div className="bg-white/5 backdrop-blur border border-white/10 rounded-xl p-3">
                    ...
                    <div className="pt-2 border-t border-slate-100 space-y-1.5">
                      ...
                      {detail.lessons.map((lesson) => (
                        <div
                          ...
                          className="flex items-center justify-between p-2 rounded-lg bg-slate-50 hover:bg-red-50/80 text-xs text-slate-700 hover:text-red-900 cursor-pointer transition-colors border border-slate-100 hover:border-red-200"
                        >
